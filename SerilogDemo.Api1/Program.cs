        ...
        public static async Task Main(string[] args)
        {
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                Log.Logger = new LoggerConfiguration().MinimumLevel.Information()
                    ...
                    path: Path.Combine("C:\\Desarrollos .NET\\Proyectos\\Demos\\SerilogDemo\\Api1\\SerilogDemo.Api1\\SerilogDemo.Api1\\logs", "logFile.txt")
                    )
                    .Enrich.With(new CustomEnricher(currentUserService))
                    .Enrich.WithAssemblyName()
                    .Enrich.WithClientIp()
                    ...
                    .WriteTo.Seq(serverUrl: "http://localhost:5341/", apiKey: "Api1-Weather")
                    .Enrich.With(new CustomEnricher(currentUserService))
                    .Enrich.WithAssemblyName()
                    .Enrich.WithClientIp()
                    .Enrich.WithClientAgent()
